...
static int ecp_mod_p256k1(mbedtls_mpi *);
		...
		#define LOAD_GROUP_A(G)                                                                           \
			ecp_group_load(grp, G##_p, sizeof(G##_p), G##_a, sizeof(G##_a), G##_b, sizeof(G##_b), G##_gx, \
				sizeof(G##_gx), G##_gy, sizeof(G##_gy), G##_n, sizeof(G##_n))
...
static inline int ecp_mod_koblitz(mbedtls_mpi *N, mbedtls_mpi_uint *Rp, size_t p_limbs, size_t adjust, size_t shift,
