...
#define MBEDTLS_SSL_PAYLOAD_OVERHEAD \
	(MBEDTLS_SSL_COMPRESSION_ADD + MBEDTLS_MAX_IV_LENGTH + MBEDTLS_SSL_MAC_ADD + MBEDTLS_SSL_PADDING_ADD)
...
extern "C"
{
	...
	struct mbedtls_ssl_handshake_params
	{
		...
		int (*tls_prf)(const unsigned char *, size_t, const char *, const unsigned char *, size_t, unsigned char *,
			size_t);
