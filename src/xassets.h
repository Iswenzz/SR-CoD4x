...
extern "C"
{
	...
	void __cdecl DB_EnumXAssets_FastFile(enum XAssetType type, void(__cdecl *func)(void *header, void *), void *inData,
		bool includeOverride);
	void __cdecl DB_EnumXAssets(enum XAssetType type, void(__cdecl *func)(union XAssetHeader, void *), void *inData,
		bool includeOverride);
	union XAssetHeader __cdecl DB_FindXAssetHeader(enum XAssetType type, const char *name, bool errorIfMissing,
		int waitTime);
	...
	static inline __attribute__((always_inline)) union XAssetHeader DB_FindXAssetHeader(enum XAssetType type, const char
	*name)
	{
