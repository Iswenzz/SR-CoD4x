...
static client_fields_s fields[] = { { "sessionteam", 0, F_STRING, &ClientScr_SetSessionTeam,
	...
	{ "kills", CSF(sess.kills), F_INT, NULL, NULL }, { "deaths", CSF(sess.deaths), F_INT, NULL, NULL },
	...
	{ "localization", 0, F_INT, &ClientScr_ReadOnly, &ClientScr_GetLocalization }, { NULL, 0, F_INT, NULL, NULL } };
