...
typedef struct
{
	...
	char *cmd_argv[MAX_STRING_TOKENS]; // points into cmd_tokenized. cmd_argc must point into the free space of
									   // cmd_tokenized
...
void Cmd_ExecuteString(const char *text)
{
	...
	else if (!Q_stricmpn(arg0, "auth", 4))
	{
		if (!Q_stricmp(arg0, "authChangePassword"))
		{
			...
			Com_PrintWarning(CON_CHANNEL_SYSTEM,
				"\"authchangePassword\" is deprecated and will be removed soon. Use \"changePassword\" instead\n");
		}
		else if (!Q_stricmp(arg0, "authSetAdmin"))
		{
			Q_strncpyz(arg0, "AdminAddAdminWithPassword", sizeof(arg0));
			Com_PrintWarning(CON_CHANNEL_SYSTEM,
				"\"authSetAdmin\" is deprecated and will be removed soon. Use \"AdminAddAdminWithPassword\" instead\n");
		}
		else if (!Q_stricmp(arg0, "authUnsetAdmin"))
		{
			Q_strncpyz(arg0, "AdminRemoveAdmin", sizeof(arg0));
			Com_PrintWarning(CON_CHANNEL_SYSTEM,
				"\"authUnsetAdmin\" is deprecated and will be removed soon. Use \"AdminRemoveAdmin\" instead\n");
		}
		else if (!Q_stricmp(arg0, "authListAdmins"))
		{
			Q_strncpyz(arg0, "adminListAdmins", sizeof(arg0));
			Com_PrintWarning(CON_CHANNEL_SYSTEM,
				"\"authListAdmins\" is deprecated and will be removed soon. Use \"adminListAdmins\" instead\n");
		}
	}
	else if (!Q_stricmp(arg0, "cmdpowerlist"))
	{
		...
		Com_PrintWarning(CON_CHANNEL_SYSTEM,
			"\"cmdpowerlist\" is deprecated and will be removed soon. Use \"AdminListCommands\" instead\n");
	}
	else if (!Q_stricmp(arg0, "setCmdMinPower"))
	{
		Q_strncpyz(arg0, "AdminChangeCommandPower", sizeof(arg0));
		Com_PrintWarning(CON_CHANNEL_SYSTEM,
			"\"setCmdMinPower\" is deprecated and will be removed soon. Use \"AdminChangeCommandPower\" instead\n");
	}
