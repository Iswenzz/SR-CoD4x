...
extern "C"
{
	...
	*/
	void Com_ScriptError(const char *msg, ...)
	{
		...
		{
			pi = &parse->parseInfo[parse->parseInfoNum];
			Com_PrintError(CON_CHANNEL_PARSERSCRIPT, "%sFile %s, line %i: %s", pi->errorPrefix, pi->parseFile,
				pi->lines, string);
		}
		else
		{
	...
	void Com_ScriptWarning(const char *msg, ...)
	{
		...
		{
			pi = &parse->parseInfo[parse->parseInfoNum];
			Com_PrintWarning(CON_CHANNEL_PARSERSCRIPT, "%sFile %s, line %i: %s", pi->warningPrefix, pi->parseFile,
				pi->lines, string);
		}
		else
		{
