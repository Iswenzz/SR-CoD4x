...
#define BSWAP(x) \
	(((x >> 24) & 0x000000FFUL) | ((x << 24) & 0xFF000000UL) | ((x >> 8) & 0x0000FF00UL) | ((x << 8) & 0x00FF0000UL))
...
#elif !defined(__STRICT_ANSI__) && defined(__GNUC__) && (defined(__i386__) || defined(__x86_64__)) \
...
static inline unsigned long ROR64c(unsigned long word, const int i)
{
	...
	#define ROL64(x, y)                                                                                       \
		((((x) << ((ulong64)(y) & 63)) | (((x) & CONST64(0xFFFFFFFFFFFFFFFF)) >> ((ulong64)64 - ((y) & 63)))) \
