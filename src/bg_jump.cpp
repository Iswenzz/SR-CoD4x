...
extern "C"
{
	...
	{
		jump_height =
			Cvar_RegisterFloat("jump_height", 39.0, 0.0, 1000.0, 0x180u, "The maximum height of a player's jump");
		jump_stepSize = Cvar_RegisterFloat("jump_stepSize", 18.0, 0.0, 64.0, 0x180u,
			"The maximum step up to the top of a jump arc");
		jump_slowdownEnable =
			Cvar_RegisterBool("jump_slowdownEnable", qtrue, 0x180u, "Slow player movement after jumping");
