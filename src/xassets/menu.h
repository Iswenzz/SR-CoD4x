...
typedef enum ItemMSGWindowMode_t
{
	MODE_BOTTOMUP_ALIGN_TOP =
		0, /* Text appears on bottom of list and moves up to specified Y coordinate as old text fades out. */
	MODE_BOTTOMUP_ALIGN_BOTTOM, /* Text appears on bottom of list and moves away from specified Y coordinate as new text
								   pushes it up. */
	MODE_TOPDOWN_ALIGN_TOP, /* Text appears on top of list and moves away from specified Y coordinate as new text pushes
							   it down. */
	MODE_TOPDOWN_ALIGN_BOTTOM /* Text appears on top of list and moves down to specified Y coordinate as old text fades
								 out. */
} ItemMSGWindowMode_t;
