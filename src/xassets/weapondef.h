...
extern "C"
{
	...
	void ChangeViewmodelDObj(int localClientNum, int weaponNum, char weaponModel, XModel *newHands, XModel *newGoggles,
		XModel *newRocket, XModel *newKnife, byte updateClientInfo);
