	...
	while (length >= BytesAtOnce)
	{
		for (unrolling = 0; unrolling < Unroll; unrolling++)
		{
			...
			crc = Crc32Lookup[0][four & 0xFF] ^ Crc32Lookup[1][(four >> 8) & 0xFF] ^ Crc32Lookup[2][(four >> 16) & 0xFF]
				...
				^ Crc32Lookup[5][(three >> 8) & 0xFF] ^ Crc32Lookup[6][(three >> 16) & 0xFF]
				^ Crc32Lookup[7][(three >> 24) & 0xFF] ^ Crc32Lookup[8][two & 0xFF] ^ Crc32Lookup[9][(two >> 8) & 0xFF]
			...
			crc = Crc32Lookup[0][(four >> 24) & 0xFF] ^ Crc32Lookup[1][(four >> 16) & 0xFF]
				...
				^ Crc32Lookup[13][(one >> 16) & 0xFF] ^ Crc32Lookup[14][(one >> 8) & 0xFF]
