...
extern "C"
{
	...
	cvar_t* Cvar_RegisterString(const char* var_name, const char* var_value, unsigned short flags,
		const char* var_description);
	cvar_t* Cvar_RegisterBool(const char* var_name, qboolean var_value, unsigned short flags,
		const char* var_description);
	cvar_t* Cvar_RegisterInt(const char* var_name, int var_value, int min_value, int max_value, unsigned short flags,
		const char* var_description);
	cvar_t* Cvar_RegisterEnum(const char* var_name, const char** valnames, int defaultval, unsigned short flags,
		const char* var_description);
	cvar_t* Cvar_RegisterFloat(const char* var_name, float var_value, float min_value, float max_value,
...
// will only change when C code next does a Cvar_Get(), so it can't be changed
