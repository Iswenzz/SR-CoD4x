...
void AAS_DebugLine(vec3_t start, vec3_t end, int color) { } // end of the function AAS_DebugLine
...
void AAS_ClearShownDebugLines(void) { } // end of the function AAS_ClearShownDebugLines
