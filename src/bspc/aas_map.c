...
void AAS_SetTexinfo(mapbrush_t *brush)
{
	...
	if (brush->contents
		& (CONTENTS_LADDER | CONTENTS_AREAPORTAL | CONTENTS_CLUSTERPORTAL | CONTENTS_TELEPORTER | CONTENTS_JUMPPAD
			| CONTENTS_DONOTENTER | CONTENTS_DONOTENTER_LARGE | CONTENTS_WATER | CONTENTS_LAVA | CONTENTS_SLIME
...
void AAS_CreateMapBrushes(mapbrush_t *brush, entity_t *mapent, int addbevels)
{
	...
	*/
	...
	if (!(brush->contents
			& (CONTENTS_SOLID | CONTENTS_LADDER | CONTENTS_CLUSTERPORTAL | CONTENTS_DONOTENTER
				| CONTENTS_DONOTENTER_LARGE | CONTENTS_TELEPORTER | CONTENTS_JUMPPAD | CONTENTS_WATER | CONTENTS_LAVA
	...
	if (brush->contents
		& (CONTENTS_WATER | CONTENTS_LAVA | CONTENTS_SLIME | CONTENTS_TELEPORTER | CONTENTS_JUMPPAD
			| CONTENTS_DONOTENTER | CONTENTS_DONOTENTER_LARGE | CONTENTS_MOVER))
	{
