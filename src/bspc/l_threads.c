...
void ThreadShutdownSemaphore(void) { } // end of the function ThreadShutdownSemaphore
...
void WaitForAllThreadsFinished(void) { } // end of the function WaitForAllThreadsFinished
