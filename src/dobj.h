...
extern "C"
{
	...
	void __cdecl DObjGeomTraceline(DObj *obj, float *localStart, float *localEnd, int contentmask,
	...
	void __cdecl DObjSetLocalTag(DObj *obj, int *partBits, unsigned int boneIndex, const float *trans,
		const float *angles);
