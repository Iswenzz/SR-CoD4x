...
int BG_GetPerkIndexForName(const char* name)
{
	char* perks[] = { "specialty_gpsjammer", "specialty_bulletaccuracy", "specialty_fastreload", "specialty_rof",
		"specialty_holdbreath", "specialty_bulletpenetration", "specialty_grenadepulldeath", "specialty_pistoldeath",
		"specialty_quieter", "specialty_parabolic", "specialty_longersprint", "specialty_detectexplosive",
		"specialty_explosivedamage", "specialty_exposeenemy", "specialty_bulletdamage", "specialty_extraammo",
		"specialty_twoprimaries", "specialty_armorvest", "specialty_fraggrenade", "specialty_specialgrenade", NULL };
...
void Jump_RegisterCvars()
{
	...
	jump_stepSize =
		Cvar_RegisterFloat("jump_stepSize", 18.0, 0.0, 64.0, 0x180u, "The maximum step up to the top of a jump arc");
	jump_slowdownEnable = Cvar_RegisterBool("jump_slowdownEnable", qtrue, 0x180u, "Slow player movement after jumping");
	jump_ladderPushVel =
		Cvar_RegisterFloat("jump_ladderPushVel", 128.0, 0.0, 1024.0, 0x180u, "The velocity of a jump off of a ladder");
...
void Mantle_RegisterCvars(void)
{
	...
	mantle_check_range = Cvar_RegisterFloat("mantle_check_range", 20.0, 0.0, 128.0, 0x180u,
		"The minimum distance from a player to a mantle surface to allow a mantle");
	mantle_check_radius = Cvar_RegisterFloat("mantle_check_radius", 0.1, 0.0, 15.0, 0x180u,
		"The player radius to test against while mantling");
	mantle_check_angle = Cvar_RegisterFloat("mantle_check_angle", 60.0, 0.0, 180.0, 0x180u,
		"The minimum angle from the player to a mantle surface to allow a mantle");
	mantle_view_yawcap = Cvar_RegisterFloat("mantle_view_yawcap", 60.0, 0.0, 180.0, 0x180u,
		"The angle at which to restrict a sideways turn while mantling");
}

void Perks_RegisterCvars(void)
{
	perk_weapSpreadMultiplier = Cvar_RegisterFloat("perk_weapSpreadMultiplier", 0.64999998, 0.0, 1.0, 0x80u,
		"Percentage of weapon spread to use");
	perk_weapReloadMultiplier = Cvar_RegisterFloat("perk_weapReloadMultiplier", 0.5, 0.0, 1.0, 0x80u,
		"Percentage of weapon reload time to use");
	perk_weapRateMultiplier =
		Cvar_RegisterFloat("perk_weapRateMultiplier", 0.75, 0.0, 1.0, 0x80u, "Percentage of weapon firing rate to use");
	perk_extraBreath = Cvar_RegisterFloat("perk_extraBreath", 5.0, 0.0, 3.4028235e38, 0x80u,
		"Number of extra seconds a player can hold his breath");
	perk_bulletPenetrationMultiplier = Cvar_RegisterFloat("perk_bulletPenetrationMultiplier", 2.0, 0.0, 30.0, 0x80u,
		"Multiplier for extra bullet penetration");
	perk_grenadeDeath =
		Cvar_RegisterString("perk_grenadeDeath", "frag_grenade_short_mp", 0x80u, "Name of the grenade weapon to drop");
	perk_parabolicRadius = Cvar_RegisterFloat("perk_parabolicRadius", 400.0, 0.0, 3.4028235e38, 0x80u,
		"Eavesdrop perk's effective radius");
	perk_parabolicAngle =
		Cvar_RegisterFloat("perk_parabolicAngle", 180.0, 0.0, 180.0, 0x80u, "Eavesdrop perk's effective FOV angle");
	perk_parabolicIcon = Cvar_RegisterString("perk_parabolicIcon", "specialty_parabolic", 0x80u,
		"Eavesdrop icon to use when displaying eavesdropped voice chats");
	perk_sprintMultiplier =
		Cvar_RegisterFloat("perk_sprintMultiplier", 2.0, 0.0, 3.4028235e38, 0x80u, "Multiplier for player_sprinttime");
}

void Helicopter_RegisterCvars()
{
	vehHelicopterMaxSpeed = Cvar_RegisterFloat("vehHelicopterMaxSpeed", 150.0, 0.0099999998, 3.4028235e38, 0x80u,
		"Maximum horizontal speed of the player helicopter (in MPH)");
	vehHelicopterMaxSpeedVertical = Cvar_RegisterFloat("vehHelicopterMaxSpeedVertical", 65.0, 0.0099999998,
		3.4028235e38, 0x80u, "Maximum vertical speed of the player helicopter (in MPH)");
	vehHelicopterMaxAccel = Cvar_RegisterFloat("vehHelicopterMaxAccel", 45.0, 0.0099999998, 3.4028235e38, 0x80u,
		"Maximum horizontal acceleration of the player helicopter (in MPH per second)");
	vehHelicopterMaxAccelVertical = Cvar_RegisterFloat("vehHelicopterMaxAccelVertical", 30.0, 0.0099999998,
		3.4028235e38, 0x80u, "Maximum vertical acceleration of the player helicopter (in MPH per second)");
	vehHelicopterMaxYawRate = Cvar_RegisterFloat("vehHelicopterMaxYawRate", 120.0, 0.0099999998, 3.4028235e38, 0x80u,
		"Maximum yaw speed of the player helicopter");
	vehHelicopterMaxYawAccel = Cvar_RegisterFloat("vehHelicopterMaxYawAccel", 90.0, 0.0099999998, 3.4028235e38, 0x80u,
		"Maximum yaw acceleration of the player helicopter");
	vehHelicopterMaxPitch = Cvar_RegisterFloat("vehHelicopterMaxPitch", 35.0, 0.0099999998, 3.4028235e38, 0x80u,
		"Maximum pitch of the player helicopter");
	vehHelicopterMaxRoll = Cvar_RegisterFloat("vehHelicopterMaxRoll", 35.0, 0.0099999998, 3.4028235e38, 0x80u,
		"Maximum roll of the player helicopter");
	vehHelicopterLookaheadTime =
		Cvar_RegisterFloat("vehHelicopterLookaheadTime", 1.0, 0.0099999998, 3.4028235e38, 0x80u,
			"How far ahead (in seconds) the player helicopter looks ahead, to avoid hard collisions. (Like driving "
			"down the highway, you should keep 2 seconds distance between you and the vehicle in front of you)");
	vehHelicopterHoverSpeedThreshold = Cvar_RegisterFloat("vehHelicopterHoverSpeedThreshold", 400.0, 0.0099999998,
		3.4028235e38, 0x80u, "The speed below which the player helicopter begins to jitter the tilt, for hovering");
	vehHelicopterRightStickDeadzone =
		Cvar_RegisterFloat("vehHelicopterRightStickDeadzone", 0.30000001, 0.0099999998, 1.0, 0x80u,
	...
	vehHelicopterStrafeDeadzone =
		Cvar_RegisterFloat("vehHelicopterStrafeDeadzone", 0.30000001, 0.0099999998, 1.0, 0x80u,
			"Dead-zone so that you can fly straight forward easily without accidentally strafing (and thus rolling).");
	vehHelicopterScaleMovement = Cvar_RegisterBool("vehHelicopterScaleMovement", qtrue, 0x80u,
		"Scales down the smaller of the left stick axes.");
	vehHelicopterSoftCollisions = Cvar_RegisterBool("vehHelicopterSoftCollisions", 0, 0x80u,
		"Player helicopters have soft collisions (slow down before they collide).");
	vehHelicopterDecelerationFwd = Cvar_RegisterFloat("vehHelicopterDecelerationFwd", 0.5, 0.0, 3.4028235e38, 0x80u,
		"Set the deceleration of the player helicopter (as a fraction of acceleration) in the direction the chopper is "
		"facing. So 1.0 makes it equal to the acceleration.");
	vehHelicopterDecelerationSide = Cvar_RegisterFloat("vehHelicopterDecelerationSide", 1.0, 0.0, 3.4028235e38, 0x80u,
		"Set the side-to-side deceleration of the player helicopter (as a fraction of acceleration). So 1.0 makes it "
		"equal to the acceleration.");
	vehHelicopterInvertUpDown = Cvar_RegisterBool("vehHelicopterInvertUpDown", 0, 0x80u,
		"Invert the altitude control on the player helicopter.");
	vehHelicopterYawOnLeftStick = Cvar_RegisterFloat("vehHelicopterYawOnLeftStick", 5.0, 0.0, 3.4028235e38, 0x80u,
		"The yaw speed created by the left stick when pushing the stick diagonally (e.g., moving forward and strafing "
		"slightly).");
	vehHelicopterTiltSpeed = Cvar_RegisterFloat("vehHelicopterTiltSpeed", 1.2, 0.0099999998, 3.4028235e38, 0x80u,
		"The rate at which the player helicopter's tilt responds");
	vehHelicopterTiltFromAcceleration = Cvar_RegisterFloat("vehHelicopterTiltFromAcceleration", 2.0, 0.0099999998,
		3.4028235e38, 0x80u, "The amount of tilt caused by acceleration");
	vehHelicopterTiltFromDeceleration = Cvar_RegisterFloat("vehHelicopterTiltFromDeceleration", 2.0, 0.0, 3.4028235e38,
		0x80u, "The amount of tilt caused by deceleration");
	vehHelicopterTiltFromVelocity = Cvar_RegisterFloat("vehHelicopterTiltFromVelocity", 1.0, 0.0, 3.4028235e38, 0x80u,
		"The amount of tilt caused by the current velocity");
	vehHelicopterTiltFromControllerAxes =
		Cvar_RegisterFloat("vehHelicopterTiltFromControllerAxes", 0.0, 0.0, 3.4028235e38, 0x80u,
			"The amount of tilt caused by the desired velocity (i.e., the amount of controller stick deflection)");
	vehHelicopterTiltFromFwdAndYaw = Cvar_RegisterFloat("vehHelicopterTiltFromFwdAndYaw", 0.0, 0.0, 3.4028235e38, 0x80u,
		"The amount of roll caused by yawing while moving forward.");
	vehHelicopterTiltFromFwdAndYaw_VelAtMaxTilt =
		Cvar_RegisterFloat("vehHelicopterTiltFromFwdAndYaw_VelAtMaxTilt", 1.0, 0.0, 3.4028235e38, 0x80u,
			"The forward speed (as a fraction of top speed) at which the tilt due to yaw reaches is maximum value.");
	vehHelicopterJitterJerkyness = Cvar_RegisterFloat("vehHelicopterJitterJerkyness", 0.30000001, 0.000099999997,
		3.4028235e38, 0, "Specifies how jerky the tilt jitter should be");
	vehHelicopterHeadSwayDontSwayTheTurret = Cvar_RegisterBool("vehHelicopterHeadSwayDontSwayTheTurret", qtrue, 0,
		"If set, the turret will not fire through the crosshairs, but straight ahead of the vehicle, when the player "
		"is not freelooking.");
	vehHelicopterTiltMomentum = Cvar_RegisterFloat("vehHelicopterTiltMomentum", 0.40000001, 0.000099999997,
		3.4028235e38, 0x80u, "The amount of rotational momentum the helicopter has with regards to tilting.");
}

void G_VehRegisterCvars()
{
	vehDebugServer = Cvar_RegisterBool("vehDebugServer", 0, 0x80u, "Turn on debug information for vehicles");
	vehTextureScrollScale = Cvar_RegisterFloat("vehTextureScrollScale", 0.0, 0.0, 3.4028235e38, 0x80u,
...
{
	missileHellfireMaxSlope = Cvar_RegisterFloat("missileHellfireMaxSlope", 0.5, 0.0, 3.4028235e38, 0x80u,
		"This limits how steeply the hellfire missile can turn upward when climbing");
	missileHellfireUpAccel = Cvar_RegisterFloat("missileHellfireUpAccel", 1000.0, 0.1, 3.4028235e38, 0x80u,
		"The rate at which the hellfire missile curves upward");
	missileJavClimbHeightDirect = Cvar_RegisterFloat("missileJavClimbHeightDirect", 10000.0, 0.0, 3.4028235e38, 0x80u,
		"In direct-fire mode, how far above the target the rocket will aim for when climbing.");
	missileJavClimbHeightTop = Cvar_RegisterFloat("missileJavClimbHeightTop", 15000.0, 0.0, 3.4028235e38, 0x80u,
		"In top-fire mode, how far above the target the rocket will aim for when climbing.");
	missileJavClimbAngleDirect = Cvar_RegisterFloat("missileJavClimbAngleDirect", 85.0, 0.0, 3.4028235e38, 0x80u,
		"In direct-fire mode, the minimum angle between the rocket and target until the rocket stops climbing. Smaller "
		"angles make for higher climbs.");
	missileJavClimbAngleTop = Cvar_RegisterFloat("missileJavClimbAngleTop", 50.0, 0.0, 3.4028235e38, 0x80u,
		"In top-fire mode, the minimum angle between the rocket and target until the rocket stops climbing. Smaller "
		"angles make for higher climbs.");
	missileJavClimbCeilingDirect = Cvar_RegisterFloat("missileJavClimbCeilingDirect", 0.0, 0.0, 3.4028235e38, 0x80u,
		"In direct-fire mode, how high the missile needs to reach before it descends.");
	missileJavClimbCeilingTop = Cvar_RegisterFloat("missileJavClimbCeilingTop", 3000.0, 0.0, 3.4028235e38, 0x80u,
		"In top-fire mode, how high the missile needs to reach before it descends.");
	missileJavTurnRateDirect = Cvar_RegisterFloat("missileJavTurnRateDirect", 60.0, 0.0, 3.4028235e38, 0x80u,
		"In direct-fire mode, how sharp the rocket can turn, in angles/sec.");
	missileJavTurnRateTop = Cvar_RegisterFloat("missileJavTurnRateTop", 100.0, 0.0, 3.4028235e38, 0x80u,
		"In top-fire mode, how sharp the rocket can turn, in angles/sec.");
	missileJavAccelClimb = Cvar_RegisterFloat("missileJavAccelClimb", 300.0, 0.0, 3.4028235e38, 0x80u,
		"Rocket acceleration when climbing.");
	missileJavAccelDescend = Cvar_RegisterFloat("missileJavAccelDescend", 3000.0, 0.0, 3.4028235e38, 0x80u,
		"Rocket acceleration when descending towards target.");
	missileJavSpeedLimitClimb = Cvar_RegisterFloat("missileJavSpeedLimitClimb", 1000.0, 0.0, 3.4028235e38, 0x80u,
		"Rocket's speed limit when climbing.");
	missileJavSpeedLimitDescend = Cvar_RegisterFloat("missileJavSpeedLimitDescend", 6000.0, 0.0, 3.4028235e38, 0x80u,
	...
	missileWaterMaxDepth = Cvar_RegisterFloat("missileWaterMaxDepth", 60.0, 0.0, 3.4028235e38, 0x80u,
...
void G_RegisterMissileDebugCvars()
{
	...
	missileDebugAttractors = Cvar_RegisterBool("missileDebugAttractors", 0, 0,
...
void BG_RegisterCvars()
{
	...
	static const char* bg_soundRoomTypes[] = { "generic", "paddedcell", "room", "bathroom", "livingroom", "stoneroom",
		"auditorium", "concerthall", "cave", "arena", "hangar", "carpetedhallway", "hallway", "stonecorridor", "alley",
		"forest", "city", "mountains", "quarry", "plain", "parkinglot", "sewerpipe", "underwater", "drugged", "dizzy",
		"psychotic", NULL };

	bg_viewKickScale = Cvar_RegisterFloat("bg_viewKickScale", 0.2, 0.0, 10.0, 0x80u,
	...
	bg_viewKickRandom =
		Cvar_RegisterFloat("bg_viewKickRandom", 0.40000001, 0.0, 1.0, 0x80u, "The random direction scale view kick");
	player_view_pitch_up = Cvar_RegisterFloat("player_view_pitch_up", 85.0, 0.0, 90.0, 0x180u,
		"Maximum angle that the player can look up");
	player_view_pitch_down = Cvar_RegisterFloat("player_view_pitch_down", 85.0, 0.0, 90.0, 0x180u,
		"Maximum angle that the player can look down");
	player_lean_shift_left = Cvar_RegisterFloat("player_lean_shift_left", 5.0, 0.0, 20.0, 0x180u,
		"Amount to shift the player 3rd person model when leaning left");
	player_lean_shift_right = Cvar_RegisterFloat("player_lean_shift_right", 9.0, 0.0, 20.0, 0x180u,
		"Amount to shift the player 3rd person model when leaning right");
	player_lean_shift_crouch_left = Cvar_RegisterFloat("player_lean_shift_crouch_left", 4.0, 0.0, 20.0, 0x180u,
		"Amount to shift the player 3rd person model when crouch leaning left");
	player_lean_shift_crouch_right = Cvar_RegisterFloat("player_lean_shift_crouch_right", 15.0, 0.0, 20.0, 0x180u,
		"Amount to shift the player 3rd person model when crouch leaning right");
	player_lean_rotate_left = Cvar_RegisterFloat("player_lean_rotate_left", 0.80000001, 0.0, 3.0, 0x180u,
		"Amount to rotate the player 3rd person model when leaning left");
	player_lean_rotate_right = Cvar_RegisterFloat("player_lean_rotate_right", 0.40000001, 0.0, 3.0, 0x180u,
		"Amount to rotate the player 3rd person model when leaning right");
	player_lean_rotate_crouch_left = Cvar_RegisterFloat("player_lean_rotate_crouch_left", 0.80000001, 0.0, 3.0, 0x180u,
		"Amount to rotate the player 3rd person model when crouch leaning left");
	player_lean_rotate_crouch_right = Cvar_RegisterFloat("player_lean_rotate_crouch_right", 0.30000001, 0.0, 3.0,
		0x180u, "Amount to rotate the player 3rd person model when crouch leaning right");
	bg_ladder_yawcap = Cvar_RegisterFloat("bg_ladder_yawcap", 100.0, 0.0, 360.0, 0x180u,
		"The maximum angle that a player can look around while on a ladder");
	bg_prone_yawcap = Cvar_RegisterFloat("bg_prone_yawcap", 85.0, 0.0, 360.0, 0x180u,
		"The maximum angle that a player can look around quickly while prone");
	bg_foliagesnd_minspeed = Cvar_RegisterFloat("bg_foliagesnd_minspeed", 40.0, 0.0, 3.4028235e38, 0x180u,
		"The speed that a player must be going to make minimum noise while moving through foliage");
	bg_foliagesnd_maxspeed = Cvar_RegisterFloat("bg_foliagesnd_maxspeed", 180.0, 0.0, 3.4028235e38, 0x180u,
		"The speed that a player must be going to make maximum noise while moving through foliage");
	bg_foliagesnd_slowinterval = Cvar_RegisterInt("bg_foliagesnd_slowinterval", 1500, 0, 2147483647, 0x180u,
		"The time between each foliage sound when moving slowly");
	bg_foliagesnd_fastinterval = Cvar_RegisterInt("bg_foliagesnd_fastinterval", 500, 0, 2147483647, 0x180u,
		"The time between each foliage sound when moving quickly");
	bg_foliagesnd_resetinterval = Cvar_RegisterInt("bg_foliagesnd_resetinterval", 500, 0, 2147483647, 0x180u,
		"The time interval before foliage sounds are reset after the player has stopped moving");
	bg_fallDamageMinHeight = Cvar_RegisterFloat("bg_fallDamageMinHeight", 128.0, 1.0, 3.4028235e38, 0x188u,
		"The height that a player will start to take minimum damage if they fall");
	bg_fallDamageMaxHeight = Cvar_RegisterFloat("bg_fallDamageMaxHeight", 300.0, 1.0, 3.4028235e38, 0x188u,
	...
	inertiaAngle =
		Cvar_RegisterFloat("inertiaAngle", 0.0, -1.0, 1.0, 0x180u, "The cosine of the angle at which inertia occurs");
	...
	bg_swingSpeed = Cvar_RegisterFloat("bg_swingSpeed", 0.2, 0.0, 1.0, 0x80u,
		"The rate at which the player's legs swing around when strafing(multi-player only)");
	bg_legYawTolerance = Cvar_RegisterFloat("bg_legYawTolerance", 20.0, 0.0, 180.0, 0x80u,
		"The amount the player's leg yaw can differ from his torso before moving ta match");
	bg_bobAmplitudeSprinting = Cvar_RegisterVec2("bg_bobAmplitudeSprinting", 0.02, 0.014, 0.0, 1.0, 384,
		"The multiplier to apply to the player's speed to get the bob amplitude while sprinting");
	bg_bobAmplitudeStanding = Cvar_RegisterVec2("bg_bobAmplitudeStanding", 0.0070000002, 0.0070000002, 0.0, 1.0, 4480,
		"The multiplier to apply to the player's speed to get the bob amplitude while standing");
	bg_bobAmplitudeDucked = Cvar_RegisterVec2("bg_bobAmplitudeDucked", 0.0074999998, 0.0074999998, 0.0, 1.0, 384,
		"The multiplier to apply to the player's speed to get the bob amplitude while ducking");
	bg_bobAmplitudeProne = Cvar_RegisterVec2("bg_bobAmplitudeProne", 0.02, 0.0049999999, 0.0, 1.0, 384,
	...
	bg_aimSpreadMoveSpeedThreshold = Cvar_RegisterFloat("bg_aimSpreadMoveSpeedThreshold", 11.0, 0.0, 300.0, 0x180u,
		"When player is moving faster than this speed, the aim spread will increase");
	bg_maxGrenadeIndicatorSpeed = Cvar_RegisterFloat("bg_maxGrenadeIndicatorSpeed", 20.0, 0.0, 1000.0, 0x180u,
		"Maximum speed of grenade that will show up in indicator and can be thrown back.");
	player_breath_hold_time = Cvar_RegisterFloat("player_breath_hold_time", 4.5, 0.0, 30.0, 0x180u,
		"The maximum time a player can hold his breath");
	player_breath_gasp_time = Cvar_RegisterFloat("player_breath_gasp_time", 1.0, 0.0, 30.0, 0x180u,
		"The amount of time a player will gasp once they can breath again");
	player_breath_fire_delay = Cvar_RegisterFloat("player_breath_fire_delay", 0.0, 0.0, 30.0, 0x180u,
		"The amount of time subtracted from the player remaining breath time when a weapon is fired");
	player_breath_gasp_scale = Cvar_RegisterFloat("player_breath_gasp_scale", 4.5, 0.0, 50.0, 0x180u,
		"Scale value to apply to the target waver during a gasp");
	player_breath_hold_lerp = Cvar_RegisterFloat("player_breath_hold_lerp", 1.0, 0.0, 50.0, 0x180u,
		"The interpolation rate for the target waver amplitude when holding breath");
	player_breath_gasp_lerp = Cvar_RegisterFloat("player_breath_gasp_lerp", 6.0, 0.0, 50.0, 0x180u,
		"The interpolation rate for the target waver amplitude when gasping");
	player_breath_snd_lerp = Cvar_RegisterFloat("player_breath_snd_lerp", 2.0, 0.0, 100.0, 0x180u,
		"The interpolation rate for the player hold breath sound");
	player_breath_snd_delay = Cvar_RegisterFloat("player_breath_snd_delay", 1.0, 0.0, 2.0, 0x180u,
		"The delay before playing the breathe in sound");
	player_scopeExitOnDamage =
		Cvar_RegisterBool("player_scopeExitOnDamage", 0, 0x180u, "Exit the scope if the player takes damage");
	player_adsExitDelay =
		Cvar_RegisterInt("player_adsExitDelay", 0, 0, 1000, 0x180u, "Delay before exiting aim down sight");
	player_move_factor_on_torso = Cvar_RegisterFloat("player_move_factor_on_torso", 0.0, 0.0, 1.0, 0x80u,
	...
	player_sustainAmmo =
		Cvar_RegisterBool("player_sustainAmmo", 0, 0x80u, "Firing weapon will not decrease clip ammo.");
	player_moveThreshhold = Cvar_RegisterFloat("player_moveThreshhold", 10.0, 0.0000000099999999, 20.0, 0x1C0u,
		"The speed at which the player is considered to be moving for the purposes of \nview model bob and multiplayer "
		"model movement");
	player_footstepsThreshhold = Cvar_RegisterFloat("player_footstepsThreshhold", 0.0, 0.0, 50000.0, 0x1C0u,
		"The minimum speed at which the player makes loud footstep noises");
	player_strafeSpeedScale = Cvar_RegisterFloat("player_strafeSpeedScale", 0.80000001, 0.0, 20.0, 0x180u,
		"The scale applied to the player speed when strafing");
	player_backSpeedScale = Cvar_RegisterFloat("player_backSpeedScale", 0.69999999, 0.0, 20.0, 0x180u,
		"The scale applied to the player speed when moving backwards");
	player_strafeAnimCosAngle = Cvar_RegisterFloat("player_strafeAnimCosAngle", 0.5, 0.0, 1.0, 0x180u,
		"Cosine of the angle which player starts using strafe animations");
	player_spectateSpeedScale = Cvar_RegisterFloat("player_spectateSpeedScale", 1.0, 0.0, 20.0, 0x180u,
		"The scale applied to the player speed when spectating");
	player_sprintForwardMinimum = Cvar_RegisterInt("player_sprintForwardMinimum", 105, 0, 255, 0x100u,
		"The minimum forward deflection required to maintain a sprint");
	player_sprintSpeedScale = Cvar_RegisterFloat("player_sprintSpeedScale", 1.5, 0.0, 5.0, 0x180u,
		"The scale applied to the player speed when sprinting");
	player_sprintTime =
		Cvar_RegisterFloat("player_sprintTime", 4.0, 0.0, 12.8, 0x180u, "The base length of time a player can sprint");
	player_sprintMinTime = Cvar_RegisterFloat("player_sprintMinTime", 1.0, 0.0, 12.8, 0x180u,
		"The minimum sprint time needed in order to start sprinting");
	player_sprintRechargePause = Cvar_RegisterFloat("player_sprintRechargePause", 0.0, 0.0, 9000.0, 0x180u,
		"The length of time the meter will pause before starting to recharge after a player sprints");
	player_sprintStrafeSpeedScale = Cvar_RegisterFloat("player_sprintStrafeSpeedScale", 0.667, 0.0, 5000.0, 0x180u,
		"The speed at which you can strafe while sprinting");
	player_sprintCameraBob = Cvar_RegisterFloat("player_sprintCameraBob", 0.5, 0.0, 2.0, 0x180u,
		"The speed the camera bobs while you sprint");
	player_turnAnims =
		Cvar_RegisterBool("player_turnAnims", 0, 0x180u, "Use animations to turn a player's model in multiplayer");
	player_dmgtimer_timePerPoint = Cvar_RegisterFloat("player_dmgtimer_timePerPoint", 100.0, 0.0, 30000.0, 0x180u,
		"The time in milliseconds that the player is slowed down per point of damage");
	player_dmgtimer_maxTime = Cvar_RegisterFloat("player_dmgtimer_maxTime", 750.0, 0.0, 64000.0, 0x180u,
		"The maximum time that the player is slowed due to damage");
	player_dmgtimer_minScale = Cvar_RegisterFloat("player_dmgtimer_minScale", 0.0, 0.0, 1.0, 0x180u,
		"The minimum scale value to slow the player by when damaged");
	player_dmgtimer_stumbleTime = Cvar_RegisterInt("player_dmgtimer_stumbleTime", 500, 0, 2000, 0x180u,
		"Maximum time to play stumble animations");
	player_dmgtimer_flinchTime =
		Cvar_RegisterInt("player_dmgtimer_flinchTime", 500, 0, 2000, 0x180u, "Maximum time to play flinch animations");
	bg_shock_soundLoop = Cvar_RegisterString("bg_shock_soundLoop", "shellshock_loop", 0x80u, "Shellshock loop alias");
	bg_shock_soundLoopSilent = Cvar_RegisterString("bg_shock_soundLoopSilent", "shellshock_loop_silent", 0x80u,
	...
	bg_shock_soundEndAbort = Cvar_RegisterString("bg_shock_soundEndAbort", "shellshock_end_abort", 0x80u,
		"Shellshock aborted end sound alias");
	bg_shock_screenType =
		Cvar_RegisterEnum("bg_shock_screenType", bg_ShockScreenTypeNames, 0, 0x80u, "Shell shock screen effect type");
	bg_shock_screenBlurBlendTime = Cvar_RegisterFloat("bg_shock_screenBlurBlendTime", 0.40000001, 0.001, 10.0, 0x80u,
		"The amount of time in seconds for the shellshock effect to blend");
	bg_shock_screenBlurBlendFadeTime = Cvar_RegisterFloat("bg_shock_screenBlurBlendFadeTime", 1.0, 0.001, 1000.0, 0x80u,
		"The amount of time in seconds for the shellshock effect to fade");
	bg_shock_screenFlashWhiteFadeTime = Cvar_RegisterFloat("bg_shock_screenFlashWhiteFadeTime", 1.0, 0.0, 1000.0, 0x80u,
		"In seconds, how soon from the end of the effect to start blending out the whiteout layer.");
	bg_shock_screenFlashShotFadeTime = Cvar_RegisterFloat("bg_shock_screenFlashShotFadeTime", 1.0, 0.0, 1000.0, 0x80u,
		"In seconds, how soon from the end of the effect to start blending out the screengrab layer.");
	bg_shock_viewKickPeriod = Cvar_RegisterFloat("bg_shock_viewKickPeriod", 0.75, 0.001, 1000.0, 0x80u,
		"The period of the shellshock view kick effect");
	bg_shock_viewKickRadius =
		Cvar_RegisterFloat("bg_shock_viewKickRadius", 0.050000001, 0.0, 1.0, 0x80u, "Shell shock kick radius");
	bg_shock_viewKickFadeTime = Cvar_RegisterFloat("bg_shock_viewKickFadeTime", 3.0, 0.001, 1000.0, 0x80u,
	...
	bg_shock_soundFadeInTime = Cvar_RegisterFloat("bg_shock_soundFadeInTime", 0.25, 0.001, 1000.0, 0x80u,
		"Shell shock sound fade in time in seconds");
	bg_shock_soundFadeOutTime = Cvar_RegisterFloat("bg_shock_soundFadeOutTime", 2.5, 0.001, 1000.0, 0x80u,
		"Shell shock sound fade out time in seconds");
	bg_shock_soundLoopFadeTime = Cvar_RegisterFloat("bg_shock_soundLoopFadeTime", 1.5, 0.001, 1000.0, 0x80u,
		"Shell shock sound loop fade time in seconds");
	bg_shock_soundLoopEndDelay = Cvar_RegisterFloat("bg_shock_soundLoopEndDelay", -3.0, -10.0, 1000.0, 0x80u,
		"Sound loop end offset time from the end of the shellshock in seconds");
	bg_shock_soundRoomType =
		Cvar_RegisterEnum("bg_shock_soundRoomType", bg_soundRoomTypes, 0, 0x80u, "Shell shock sound room type");
	bg_shock_soundDryLevel =
		Cvar_RegisterFloat("bg_shock_soundDryLevel", 1.0, 0.0, 1.0, 0x80u, "Shell shock sound dry level");
	bg_shock_soundWetLevel =
		Cvar_RegisterFloat("bg_shock_soundWetLevel", 0.5, 0.0, 1.0, 0x80u, "Shell shock sound wet level");
	bg_shock_soundModEndDelay = Cvar_RegisterFloat("bg_shock_soundModEndDelay", 2.0, -1000.0, 1000.0, 0x80u,
	...
	bg_shock_lookControl =
		Cvar_RegisterBool("bg_shock_lookControl", qtrue, 0x80u, "Alter player control during shellshock");
	bg_shock_lookControl_maxpitchspeed = Cvar_RegisterFloat("bg_shock_lookControl_maxpitchspeed", 90.0, 0.0,
		3.4028235e38, 0x80u, "Maximum pitch movement rate while shellshocked in degrees per second");
	bg_shock_lookControl_maxyawspeed = Cvar_RegisterFloat("bg_shock_lookControl_maxyawspeed", 90.0, 0.0, 3.4028235e38,
		0x80u, "Maximum yaw movement rate while shell shocked in degrees per second");
	bg_shock_lookControl_mousesensitivityscale = Cvar_RegisterFloat("bg_shock_lookControl_mousesensitivityscale", 0.5,
		0.0, 2.0, 0x80u, "Sensitivity scale to apply to a shellshocked player");
	bg_shock_lookControl_fadeTime = Cvar_RegisterFloat("bg_shock_lookControl_fadeTime", 2.0, 0.001, 1000.0, 0x80u,
		"The time for the shellshock player control to fade in seconds");
	bg_shock_movement =
		Cvar_RegisterBool("bg_shock_movement", qtrue, 0x80u, "Affect player's movement speed duringi shellshock");
	player_meleeRange = Cvar_RegisterFloat("player_meleeRange", 64.0, 0.0, 1000.0, 0x80u,
		"The maximum range of the player's mellee attack");
	player_meleeWidth =
		Cvar_RegisterFloat("player_meleeWidth", 10.0, 0.0, 1000.0, 0x80u, "The width of the player's melee attack");
	player_meleeHeight =
		Cvar_RegisterFloat("player_meleeHeight", 10.0, 0.0, 1000.0, 0x80u, "The height of the player's melee attack");
	player_meleeChargeFriction = Cvar_RegisterFloat("player_meleeChargeFriction", 1200.0, 1.0, 5000.0, 0x80u,
		"Friction used during melee charge");
	player_burstFireCooldown = Cvar_RegisterFloat("player_burstFireCooldown", 0.2, 0.0, 60.0, 0x80u,
		"Seconds after a burst fire before weapons can be fired again.");
	bullet_penetrationMinFxDist = Cvar_RegisterFloat("bullet_penetrationMinFxDist", 30.0, 0.0, 1024.0, 0x80u,
...
void __cdecl G_RegisterCvars()
{
	...
	g_disabledefcmdprefix =
		Cvar_RegisterBool("g_disabledefcmdprefix", qtrue, 0, "Disable the interpretation of the !-sign as command");
	g_allowConsoleSay =
		Cvar_RegisterBool("g_allowConsoleSay", qtrue, 0, "Flag whether to allow chat from ingame console");
	...
	g_maxclients = Cvar_RegisterInt("g_maxclients", SV_GameGetMaxClients(), 1, 64, CVAR_ROM,
		"Max clients allowed on server - use sv_maxclients to change");
	g_synchronousClients = Cvar_RegisterBool("g_synchronousClients", 0, 8u,
	...
	g_logTimeStampInSeconds = Cvar_RegisterBool("g_logTimeStampInSeconds", 0, 1u,
	...
	g_gravity =
		Cvar_RegisterFloat("g_gravity", 800.0, 1.0, 3.4028235e38, 0, "Game gravity in inches per second per second");
	...
	g_inactivity =
		Cvar_RegisterInt("g_inactivity", 0, 0, 2147483647, 0, "Time delay before player is kicked for inactivity");
	...
	bullet_penetrationEnabled =
		Cvar_RegisterBool("bullet_penetrationEnabled", qtrue, 0x80u, "Enable/Disable bullet penetration.");
	...
	g_dropForwardSpeed =
		Cvar_RegisterFloat("g_dropForwardSpeed", 10.0, 0.0, 1000.0, 1u, "Forward speed of a dropped item");
	g_dropUpSpeedBase = Cvar_RegisterFloat("g_dropUpSpeedBase", 10.0, 0.0, 1000.0, 1u,
		"Base component of the initial vertical speed of a dropped item");
	g_dropUpSpeedRand = Cvar_RegisterFloat("g_dropUpSpeedRand", 5.0, 0.0, 1000.0, 1u,
		"Random component of the initial vertical speed of a dropped item");
	g_dropHorzSpeedRand = Cvar_RegisterFloat("g_dropHorzSpeedRand", 100.0, 0.0, 1000.0, 1u,
		"Random component of the initial horizontal speed of a dropped item");
	g_clonePlayerMaxVelocity = Cvar_RegisterFloat("g_clonePlayerMaxVelocity", 80.0, 0.0, 3.4028235e38, 1u,
	...
	g_voiceChatTalkingDuration = Cvar_RegisterInt("g_voiceChatTalkingDuration", 500, 0, 10000, 1u,
		"Time after the last talk packet was received that the player is considered by the\nserver to still be talking "
		"in milliseconds");
	g_TeamIcon_Allies = Cvar_RegisterString("g_TeamIcon_Allies", "faction_128_usmc", 0x100u,
		"Shader name for the allied scores banner");
	g_TeamIcon_Axis =
		Cvar_RegisterString("g_TeamIcon_Axis", "faction_128_arab", 0x100u, "Shader name for the axis scores banner");
	g_TeamIcon_Free =
		Cvar_RegisterString("g_TeamIcon_Free", "", 0x100u, "Shader name for the scores of players with no team");
	g_TeamIcon_Spectator = Cvar_RegisterString("g_TeamIcon_Spectator", "", 0x100u,
		"Shader name for the scores of players who are spectators");
	g_ScoresColor_MyTeam = Cvar_RegisterColor("g_ScoresColor_MyTeam", 0.25, 0.72000003, 0.25, 1.0, 0x100u,
		"Player team color on scoreboard");
	g_ScoresColor_EnemyTeam = Cvar_RegisterColor("g_ScoresColor_EnemyTeam", 0.69, 0.07, 0.050000001, 1.0, 0x100u,
		"Enemy team color on scoreboard");
	g_ScoresColor_Spectator = Cvar_RegisterColor("g_ScoresColor_Spectator", 0.25, 0.25, 0.25, 1.0, 0x100u,
		"Spectator team color on scoreboard");
	g_ScoresColor_Free = Cvar_RegisterColor("g_ScoresColor_Free", 0.75999999, 0.77999997, 0.1, 1.0, 0x100u,
		"Free Team color on scoreboard");
	g_ScoresColor_Allies = Cvar_RegisterColor("g_ScoresColor_Allies", 0.090000004, 0.46000001, 0.07, 1.0, 0x100u,
		"Allies team color on scoreboard");
	g_ScoresColor_Axis =
		Cvar_RegisterColor("g_ScoresColor_Axis", 0.69, 0.07, 0.050000001, 1.0, 0x100u, "Axis team color on scoreboard");
	...
	g_TeamColor_Allies =
		Cvar_RegisterColor("g_TeamColor_Allies", 0.60000002, 0.63999999, 0.69, 1.0, 0x100u, "Allies team color");
	g_TeamColor_Axis =
		Cvar_RegisterColor("g_TeamColor_Axis", 0.64999998, 0.56999999, 0.41, 1.0, 0x100u, "Axis team color");
	g_TeamColor_MyTeam =
		Cvar_RegisterColor("g_TeamColor_MyTeam", 0.40000001, 0.60000002, 0.85000002, 1.0, 0x100u, "Player team color");
	g_TeamColor_EnemyTeam =
		Cvar_RegisterColor("g_TeamColor_EnemyTeam", 0.75, 0.25, 0.25, 1.0, 0x100u, "Enemy team color");
	g_TeamColor_Spectator =
		Cvar_RegisterColor("g_TeamColor_Spectator", 0.25, 0.25, 0.25, 1.0, 0x100u, "Spectator team color");
	...
	g_voteAbstainWeight = Cvar_RegisterFloat("g_voteAbstainWeight", 0.5, 0.0, 1.0, 1u,
	...
	g_debugLocDamage =
		Cvar_RegisterBool("g_debugLocDamage", 0, 0x80u, "Turn on debugging information for locational damage");
	g_friendlyfireDist = Cvar_RegisterFloat("g_friendlyfireDist", 256.0, 0.0, 15000.0, 0x80u,
		"Maximum range for disabling fire at a friendly");
	g_friendlyNameDist = Cvar_RegisterFloat("g_friendlyNameDist", 15000.0, 0.0, 15000.0, 0x80u,
	...
	radius_damage_debug =
		Cvar_RegisterBool("radius_damage_debug", 0, 0x80u, "Turn on debug lines for radius damage traces");
	player_throwbackInnerRadius = Cvar_RegisterFloat("player_throwbackInnerRadius", 90.0, 0.0, 3.4028235e38, 0x80u,
		"The radius to a live grenade player must be within initially to do a throwback");
	player_throwbackOuterRadius = Cvar_RegisterFloat("player_throwbackOuterRadius", 160.0, 0.0, 3.4028235e38, 0x80u,
		"The radius player is allow to throwback a grenade once the player has been in the inner radius");
	player_MGUseRadius = Cvar_RegisterFloat("player_MGUseRadius", 128.0, 0.0, 3.4028235e38, 0x80u,
		"The radius within which a player can mount a machine gun");
	g_minGrenadeDamageSpeed = Cvar_RegisterFloat("g_minGrenadeDamageSpeed", 400.0, 0.0, 3.4028235e38, 0x80u,
		"Minimum speed at which getting hit be a grenade will do damage (not the grenade explosion damage)");
	g_compassShowEnemies =
		Cvar_RegisterBool("g_compassShowEnemies", 0, 0x84u, "Whether enemies are visible on the compass at all times");
	pickupPrints =
		Cvar_RegisterBool("pickupPrints", 0, 0x80u, "Print a message to the game window when picking up ammo, etc.");
	g_dumpAnims =
		Cvar_RegisterInt("g_dumpAnims", -1, -1, 1023, 0x80u, "Animation debugging info for the given character number");
	g_useholdtime =
		Cvar_RegisterInt("g_useholdtime", 0, 0, 2147483647, 0, "Time to hold the 'use' button to activate use");
	g_useholdspawndelay = Cvar_RegisterInt("g_useholdspawndelay", 500, 0, 1000, 0x81u,
	...
	g_mantleBlockTimeBuffer = Cvar_RegisterInt("g_mantleBlockTimeBuffer", 500, 0, 60000, 0x80u,
	...
	BG_RegisterCvars();
	g_fogColorReadOnly = Cvar_RegisterColor("g_fogColorReadOnly", 1.0, 0.0, 0.0, 1.0, 0x10C0u,
		"Fog color that was set in the most recent call to \"setexpfog\"");
	g_fogStartDistReadOnly = Cvar_RegisterFloat("g_fogStartDistReadOnly", 0.0, 0.0, 3.4028235e38, 0x10C0u,
		"Fog start distance that was set in the most recent call to \"setexpfog\"");
	g_fogHalfDistReadOnly = Cvar_RegisterFloat("g_fogHalfDistReadOnly", 0.1, 0.0, 3.4028235e38, 0x10C0u,
		"Fog start distance that was set in the most recent call to \"setexpfog\"");
