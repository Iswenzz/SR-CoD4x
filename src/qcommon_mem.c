...
void Com_InitZoneMemory(void)
{
	...
	cv = Cvar_RegisterInt("com_zoneMegs", DEF_COMZONEMEGS, 8, 64 * 1024 * 1024, CVAR_LATCH | CVAR_ARCHIVE,
		"Amount of main zone memory allocated - needs to be increased when Z_Malloc fails");
